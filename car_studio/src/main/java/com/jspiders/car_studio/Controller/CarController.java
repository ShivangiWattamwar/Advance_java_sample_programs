package com.jspiders.car_studio.Controller;
...
import com.jspiders.car_studio.pojo.AdminPOJO;
import com.jspiders.car_studio.pojo.CarPOJO;
import com.jspiders.car_studio.service.CarService;
...
public class CarController {
	...
	//Home page Controller
		...
		public String addCar(@SessionAttribute(name = "login", required = false)AdminPOJO admin,@RequestParam String name,
									...
									ModelMap map) {
			if (admin != null) {
				CarPOJO pojo = service.addCar(name, model, fuel_type, price);
		...
		public String updateCar(@SessionAttribute(name = "login", required = false)AdminPOJO admin,@RequestParam int id,
									...
									ModelMap map) {
			if (admin != null) {
				CarPOJO pojo = service.updateCar(id, name, model, fuel_type, price);
				//Success
				if (pojo != null) {
					List<CarPOJO> cars = service.findAllCars();
